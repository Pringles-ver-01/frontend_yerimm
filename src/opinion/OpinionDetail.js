...
const OpinionDetail = () => {
    ...
    return <>
        ...
        <div className="comments">
            ...
            <button className="btn btn-default bg-blue-500 hover:bg-blue-600 text-white btn-rounded">댓글달기</button>

            <div className="flex items-start justify-start space-x-4 p-4">
                <div className="flex flex-col lg:flex-row">
                    <div className="flex flex-col w-full comment">
                        <div className="text-base font-bold ">배고픈 거북이</div>
                        <div className="text-base">정말 좋은 글 감사합니다~</div>
                    </div>
